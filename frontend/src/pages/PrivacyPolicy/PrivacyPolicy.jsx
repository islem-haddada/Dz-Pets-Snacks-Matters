  ...
  return (
    <div className="privacy-policy">
      <div className="privacy-policy-content">
        ...
        <p>
          We implement a variety of security measures to maintain the safety of your personal information. We use advanced encryption to protect sensitive information transmitted online. We also protect your information offline.
        </p>
        ...
        <ul>
          <li>When necessary to provide the service you have requested</li>
