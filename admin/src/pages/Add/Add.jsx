                ...
                <div className='add-category-price'>
                    <div className='add-category flex-col'>
                        ...
                        <select name='category' onChange={onChangeHandler} >
                            ...
                            <option value="Freeze-dried Organic Pumpkin">Freeze-dried Organic Pumpkin</option>
                            <option value="Dehydrated Organic Pumpkin">Dehydrated Organic Pumpkin</option>
                        </select>
                    </div>
